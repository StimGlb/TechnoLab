...
## Structure du projet React/Vite + Node.js

Ce projet est organisé en deux parties principales : le **Client** (front-end React/Vite) et le **Serveur** (back-end Node.js).  
Chaque partie possède sa propre arborescence, ses dépendances et ses scripts.
